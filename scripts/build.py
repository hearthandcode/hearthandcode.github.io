...
for name in ['style.css','app.js','dashboard-extras.css','catalog-popup.css','catalog.js']:shutil.copy2(root/'web'/name,out/name)
...
for page in detail_pages:
 ...
 if page['slug']=='prompt-catalog' and catalog_html:
  page_html=page_html.replace('</head>','<link rel="stylesheet" href="catalog-popup.css"><script type="module" src="catalog.js"></script></head>')
